...
- Isometric extraction images (angles: 0, 45, 90, 135, 180, 225, 270, 315 degrees) and standard extraction images (0, 90, 270 degrees)
...
```
/c:/source/game/
├── index.html              # Main 3D model viewer and sprite sheet generator .glb
├── indexFBX.html           # Main 3D model viewer and sprite sheet generator .fbx
├── sheet-animation.html    # Sprite sheet viewer and GIF exporter
├── README.md   
├── fbxViewerThree.js       # Main viewer functionality
├── js/
